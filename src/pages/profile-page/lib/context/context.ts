...
import { PROFILE, PROFILE_EDIT, PROFILE_PASSWORD_EDIT } from '../constants/profile.ts';
import { ButtonVariant, IButtonProps } from '@/shared/ui/button/Button.ts';
...
export const context = (): IProfilePageContext => {
	...
	return {
		...
		formEditContext: profilePageState === PROFILE_EDIT ? formEditContext : undefined,
		formPasswordContext: profilePageState === PROFILE_PASSWORD_EDIT ? formPasswordContext : undefined,
	};
};
